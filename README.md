...
Development, updates, feature requests, etc. see [https://github.com/hanckmann/MiLight-Control-Interface](https://github.com/hanckmann/MiLight-Control-Interface). The Python code is tested on Python 3.x.
